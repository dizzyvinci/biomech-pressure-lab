...
def scad_parametric(spec, L, WF, WH, ARCH, side):
...
module body() {{
    ...
    intersection() {{ linear_extrude(height = heel_t) outline2d(); heel_region(); }}{arch_block}
...
def main():
    ...
    if args.scan:
        ...
        code = scad_parametric(spec, args.length, args.forefoot_width,
                               args.heel_width, args.arch_height, args.side)
